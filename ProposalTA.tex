...
\begin{center}
    ...
    {\Large\bfseries Pemanfaatan \textit{Pipeline Document Parsing} untuk Rekonstruksi Dokumen Fisik ke Format Digital dengan Mempertahankan \textit{Layout} dan Gaya Visual}\\
     \vspace{3cm}
